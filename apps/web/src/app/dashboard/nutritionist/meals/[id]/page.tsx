...
import { MealMetadataCard } from '../../../admin/meals/[id]/components/meal-metadata-card'
import { MealSummaryCard } from '../../../admin/meals/[id]/components/meal-summary-card'
import { MealItemsTable } from '../../../admin/meals/[id]/components/meal-items-table'
import { AddFoodDialog } from '../../../admin/meals/[id]/components/add-food-dialog'
import { BulkSetQuantityDialog } from '../../../admin/meals/[id]/components/bulk-set-quantity-dialog'
import { MealForm } from '../../../admin/meals/components/meal-form'

export default function NutritionistMealDetailPage() {
  ...
  const { data: meal, isLoading, error, refetch } = useMeal(id, 'nutritionist')
  const updateMeal = useUpdateMeal('nutritionist')
  const deleteMeal = useDeleteMeal('nutritionist')
  ...
  const handleDeleteMeal = useCallback(async () => {
    ...
    setDeleteOpen(false)
    router.push('/dashboard/nutritionist/meals')
  ...
  if (error) {
    return (
      <div className="space-y-4">
        <Link href="/dashboard/nutritionist/meals">
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Update the meal name and description.
            </DialogDescription>
          </DialogHeader>
          <MealForm
            defaultValues={{
