...
} from '../../../admin/diet-plans/components/add-diet-plan-meal-dialog'
import { EditDietPlanMealDialog } from '../../../admin/diet-plans/[id]/components/edit-diet-plan-meal-dialog'
import { DietPlanForm } from '../../../admin/diet-plans/components/diet-plan-form'
import { DietPlanMetadataCard } from '../../../admin/diet-plans/[id]/components/diet-plan-metadata-card'
import { DietPlanMealsTable } from '../../../admin/diet-plans/[id]/components/diet-plan-meals-table'
import type { DietPlanMeal } from '@/lib/queries/diet-plans'

export default function NutritionistDietPlanDetailPage() {
