...
export const standardTextSearchSchema = z.object({
  q: z.string().trim().max(100, 'Search query must be less than 100 characters').optional(),
})
...
export const combineConditions = (conditions: (SQL<unknown> | undefined)[]): SQL<unknown> | undefined => {
