...
const emailStyles = {
  ...
  header:
    ...
    brandColors.border +
    ';',
  logoImg: 'display: block; margin: 0 auto; height: 36px; width: auto; max-width: 140px; border: 0; outline: none;',
  content: 'padding: 40px;',
  heading: 'font-size: 22px; font-weight: 600; color: ' + brandColors.text + '; margin: 0 0 12px 0; line-height: 1.35;',
  paragraph: 'font-size: 15px; color: ' + brandColors.text + '; margin: 0 0 28px 0; line-height: 1.6;',
